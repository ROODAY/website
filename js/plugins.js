...
var github = (function(){
  ...
  function render(target, repos){
    ...
    for(i = 0; i < repos.length; i++) {
      fragment += '<li><a href="'+repos[i].html_url+'" target="_blank">'+repos[i].name+'</a><p>'+escapeHtml(repos[i].description||'')+'</p></li>';
    }
...
var Space = function(n) {
    ...
    this.canvas.className = "stars";

    main.insertBefore(this.canvas, top);
