...
(function() {
	...
	function addCurStyles() {
		...
		var playerNode = document.querySelector("#tdfw");
		var playerNodeIndex = nodes.indexOf(playerNode);
		if (playerNodeIndex > -1) {
			nodes.splice(playerNodeIndex, 1);
		}
		var playerParentNodeIndex = nodes.indexOf(playerNode.parentNode);
		if (playerParentNodeIndex > -1) {
			nodes.splice(playerParentNodeIndex, 1);
		}
